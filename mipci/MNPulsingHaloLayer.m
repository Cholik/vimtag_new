...
@interface MNPulsingHaloLayer ()
@end


@implementation MNPulsingHaloLayer
...
- (id)init {
    ...
    if (self) {
        ...
        self.backgroundColor = [[UIColor colorWithRed:204.0/255.0 green:204.000/255.0 blue: 204./255 alpha:1] CGColor];
