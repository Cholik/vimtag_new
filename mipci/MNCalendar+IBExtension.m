...
#import "MNCalendar+IBExtension.h"

@implementation MNCalendar (IBExtension)
...
{
    self.appearance.cellShape = (MNCalendarCellShape)cellStyle;
}

- (MNCalendarCellStyle)cellStyle
{
    return (MNCalendarCellStyle)self.appearance.cellShape;
}
